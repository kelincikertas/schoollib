...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h3 class="pb-2">Add New Book</h3>
            <form name="add-book-form" id="add-book-form" method="post" action="{{url('admin/add-book')}}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="add-name" name="title" placeholder="Book Title">
                </div>
                <div class="form-group">
                    <label for="add-tag">Tag</label>
                    <input type="text" class="form-control" id="add-tag" name="tag"
                        placeholder="Book Tag Separate By Comma">
                </div>
                <div class="form-group">
                    <label>Content</label>
